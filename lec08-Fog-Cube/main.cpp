...
void display(GLFWwindow* window, double currentTime) {
    //glClearColor(0.137f, 0.231f, 0.423f, 1.0f);
    glClearColor(0.137f, 0.231f, 0.423f, 1.0f);
    ...
    glUniform3f(AmbientLight, 0.1f, 0.1f, 0.1f);
    glUniform3f(LightDirection, 0.0f, 0.0f, 5.0f);

    // Fog
    int FogColor = glGetUniformLocation(renderingProgram, "uFogColor");
    int FogDistance = glGetUniformLocation(renderingProgram, "uFogDistance");
    int Eye = glGetUniformLocation(renderingProgram, "uEye");
    glm::vec3 fogColor(0.137f, 0.231f, 0.423f);
    glm::vec2 forDistance(0.1f, 7.0f);
    glm::vec4 eye(3.0f, 3.0f, 3.0f, 1.0f);
    glUniform3fv(FogColor, 1, glm::value_ptr(fogColor));
    glUniform2fv(FogDistance, 1, glm::value_ptr(forDistance));
    glUniform4fv(Eye, 1, glm::value_ptr(eye));
...
int main(void)
{
    ...
    GLFWwindow* window = glfwCreateWindow(SCR_WIDTH, SCR_HEIGHT, "Fog", NULL, NULL);
