...
void display(GLFWwindow* window, double currentTime) {
    ...
    */
    ...
    projMatrix = glm::ortho(-1.0, 1.0, -1.0, 1.0, 0.0, 0.5);
...
int main(void)
{
    ...
    GLFWwindow* window = glfwCreateWindow(600, 600, "LookAt (GLM), Model Matrix, View Matrix, Projection Matrix(Orthograpics)", NULL, NULL);
