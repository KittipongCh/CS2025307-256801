...
void display(GLFWwindow* window, double currentTime) {
    ...
    glm::mat4 rotateGLM = glm::mat4(1.0);
    rotateGLM = glm::rotate(rotateGLM, glm::radians(ANGLE), glm::vec3(0.0f, 0.0f, 1.0f));
    int uniformRotate = glGetUniformLocation(renderingProgram, "uRotate");
    glUniformMatrix4fv(uniformRotate, 1, GL_FALSE, glm::value_ptr(rotateGLM));
