...
void init(GLFWwindow* window) {
    ...
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesCube1), verticesCube1, GL_STATIC_DRAW);
    

    glGenBuffers(1, &VBO_Cube2);
    glBindBuffer(GL_ARRAY_BUFFER, VBO_Cube2);
    glBufferData(GL_ARRAY_BUFFER, sizeof(verticesCube2), verticesCube2, GL_STATIC_DRAW);
...
void display(GLFWwindow* window, double currentTime) {
    ...
    */
    ...
    // Draw Cube 1
    modelMatrix = glm::translate(glm::mat4(1.0), glm::vec3(cube1X, cube1Y, cube1Z));
    ...
    // Draw Cube 2
    modelMatrix = glm::translate(glm::mat4(1.0f), glm::vec3(cube2X, cube2Y, cube2Z));
