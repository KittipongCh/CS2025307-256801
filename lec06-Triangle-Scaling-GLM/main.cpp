...
void display(GLFWwindow* window, double currentTime) {
    ...
    glm::mat4 scalingGLM = glm::mat4(1.0);
    scalingGLM = glm::scale(scalingGLM,glm::vec3(0.2f));

    int uniformScaling = glGetUniformLocation(renderingProgram, "uScaling");
    glUniformMatrix4fv(uniformScaling, 1, GL_FALSE, glm::value_ptr(scalingGLM));
