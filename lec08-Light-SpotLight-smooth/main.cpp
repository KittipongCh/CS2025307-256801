...
void display(GLFWwindow* window, double currentTime) {
    ...
    // LightCutOff
    int LightCutOff    = glGetUniformLocation(renderingProgram, "uLightCutOff");
    float angleCutOff = 12.5f;
    float lightCutOff = glm::cos(glm::radians(angleCutOff));
    //cout << "lightCutOff is : " << lightCutOff << endl;
    glUniform1f(LightCutOff, lightCutOff);

    // LightOuterCutOff
    int LightOuterCutOff = glGetUniformLocation(renderingProgram, "uLightOuterCutOff");
    float angleOuterCutOff = 17.5f;
    float lightOuterCutOff = glm::cos(glm::radians(angleOuterCutOff));
    glUniform1f(LightOuterCutOff, lightOuterCutOff);
