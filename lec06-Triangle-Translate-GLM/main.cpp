...
void display(GLFWwindow* window, double currentTime) {
    ...
    glm::mat4 translateGLM = glm::mat4(1.0);
    translateGLM = glm::translate(translateGLM, glm::vec3(0.5, -0.5, 0.0));

    int uniformTranslate = glGetUniformLocation(renderingProgram, "uTranslate");
    glUniformMatrix4fv(uniformTranslate, 1, GL_FALSE, glm::value_ptr(translateGLM));
