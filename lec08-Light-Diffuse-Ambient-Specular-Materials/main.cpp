...
void display(GLFWwindow* window, double currentTime) {
    ...
    int SpeculaLight        = glGetUniformLocation(renderingProgram, "uSpeculaLight");
    glUniform3f(LightColor, 1.0f, 1.0f, 1.0f);
    glUniform3f(LightDirection, 0.2f, 0.0f, 3.0f);
    glUniform3f(ViewPosition, 3.0f, 3.0f, 7.0f);
    
    glUniform3f(AmbientLight, 0.2f, 0.2f, 0.2f);
    glUniform3f(DiffuseLight, 0.5f, 0.5f, 0.5f);
    glUniform3f(SpeculaLight, 1.0f, 1.0f, 1.0f);

    // Material
    int MaterialAmbient     = glGetUniformLocation(renderingProgram, "uMaterialAmbient");
    int MaterialDiffuse     = glGetUniformLocation(renderingProgram, "uMaterialDiffuse");
    int MaterialSpecular    = glGetUniformLocation(renderingProgram, "uMaterialSpecular");
    int MaterialShiniess    = glGetUniformLocation(renderingProgram, "uMaterialShiniess");
    // Material - Ruby
    glm::vec3 materialAmbient(0.1745f, 0.01175f, 0.01175f);
    glm::vec3 materialDiffuse(0.61424f, 0.04136f, 0.04136f);
    glm::vec3 materialSpecular(0.727811f, 0.626959f, 0.626959f);
    float materialShininess = 0.6f;
    glUniform3fv(MaterialAmbient, 1, glm::value_ptr(materialAmbient));
    glUniform3fv(MaterialDiffuse, 1, glm::value_ptr(materialDiffuse));
    glUniform3fv(MaterialSpecular, 1, glm::value_ptr(materialSpecular));
    glUniform1f(MaterialShiniess, materialShininess);
    ...
    glm::vec3 targetPoint(0.0, 0.0, 1.0);
